...
size_t ReadU32Leb128(const uint8_t *p, const uint8_t *end,
                     uint32_t *out_value) {
  if (p < end && (p[0] & 0x80) == 0) {
...
size_t ReadS32Leb128(const uint8_t *p, const uint8_t *end,
                     uint32_t *out_value) {
  if (p < end && (p[0] & 0x80) == 0) {
...
size_t ReadS64Leb128(const uint8_t *p, const uint8_t *end,
                     uint64_t *out_value) {
  if (p < end && (p[0] & 0x80) == 0) {
